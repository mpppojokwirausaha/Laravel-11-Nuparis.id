...
<head>
    ...
    <meta property="og:description"
        content="{{ $article->excerpt ?: strip_tags(Str::limit($article->content, 160)) }}" />
    <meta property="og:image"
        content="{{ $article->article_image ? asset('storage/' . $article->article_image) : asset('storage/' . $infos->meta_image) }}" />
    ...
    <meta property="twitter:title" content="{{ $article->article_title }}" />
    ...
    <meta property="linkedin:title" content="{{ $article->article_title }}" />
